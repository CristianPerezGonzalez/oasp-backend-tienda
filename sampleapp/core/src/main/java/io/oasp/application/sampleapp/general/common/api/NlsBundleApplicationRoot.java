...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see io.oasp.application.sampleapp.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see io.oasp.application.sampleapp.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
