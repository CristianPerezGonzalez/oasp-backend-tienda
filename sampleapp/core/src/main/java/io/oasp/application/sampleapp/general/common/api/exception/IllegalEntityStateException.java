package io.oasp.application.sampleapp.general.common.api.exception;

import io.oasp.application.sampleapp.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link io.oasp.application.sampleapp.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the sampleappEntity entity.
